...
4. Are using specific software that is designed to be run on HPC Systems (multiple cores or nodes run in parallel)


Artemis is available free of charge to all University of Sydney researchers. You do need a unikey, and a valid [Research Dashboard Research Data Management Plan (DASR)](https://dashr.sydney.edu.au/) with Artemis access enabled.
...
## Specifically what is different in Artemis 
