...
Chances are for more complex workloads you'd want to set up an **environment** to manage libraries and their dependencies. We recommend using [conda environemnts](https://conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html) on Artemis by installing miniconda (most likely in the /projects directory so your colleagues can use it) and sourcing the environment within the PBS script before the python workflow is enganged. See this [running on Artemis](https://sydney-informatics-hub.github.io/training.artemis.gpu/06-Python/index.html) example on how you'd use conda and alter your PBS script.
...
Running R code on Artemis requires installing and referencing **packages** needed for your R script. 
