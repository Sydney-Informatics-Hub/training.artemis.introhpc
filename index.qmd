...
> ## Attention
> Artemis is due to be *permanently shutdown on 29 August 2025*.
> No new projects will be created on Artemis from 28 February 2025.
> Transition your work to NCI (or elsewhere) now.
> Contact research-cloud.project@sydney.edu.au for any questions or concerns.
...
All data used in the course can be found [here](https://github.com/Sydney-Informatics-Hub/IntroHPCData). "Download ZIP" under the green code button can be used to download it if you are unfamiliar with git. 
